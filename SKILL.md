...
| **Memory** | `brain.sh recall\|recall-class\|finding\|exhausted\|learn\|payload\|stats` | Persistent cross-engagement brain — **recall first, capture last**. `recall-class <class>` auto-selects class-relevant lessons via `brain/lesson-index.md`. |
