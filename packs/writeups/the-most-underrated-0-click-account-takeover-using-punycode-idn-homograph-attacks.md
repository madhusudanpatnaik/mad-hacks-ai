---
title: The Most Underrated 0-Click Account Takeover Using Punycode IDN Homograph Attacks
subtitle: Hackers Are Earning 💸$XX,000+ With This Secret Trick — Now It’s Your Turn
tags:
- Bug Bounty
- Cybersecurity
- Technology
...
updated: '2025-09-19'
free: false
freedium_url: https://freedium-mirror.cfd/https://infosecwriteups.com/the-most-underrated-0-click-account-takeover-using-punycode-idn-attacks-c0afdb74a3dc
source_url: https://infosecwriteups.com/the-most-underrated-0-click-account-takeover-using-punycode-idn-attacks-c0afdb74a3dc
---
...
*Published Jun 13, 2025 · Updated Sep 19, 2025 · Free: No*
...
This looks very similar to [security@gmail.com](mailto:security@gmail.com), but actually points to a different domain making it a powerful trick used in phishing, account takeover, and 2FA bypass attacks.
...
[**scripts/punycode_gen.py at main · coffinxp/scripts**](https://github.com/coffinxp/scripts/blob/main/punycode_gen.py)
...
[**Punycode converter (IDN converter)**](https://www.punycoder.com/)
...
1. Register this time using a **Punycode-modified username** like:
...
> 💡 **2FA Bypass Tip**: If site uses **2Fa** and application mishandles email normalization (like treating gmáil.com as gmail.com), an attacker can register as victim@gmáil.com, set up 2FA and then use their own 2FA code to log into [victim@gmail.com](mailto:victim@gmail.com).

If you don't have Burp Suite Pro, you can use the [Interactsh client](https://app.interactsh.com/#/) instead — it works just as well and is much easier to use.
...
[**Puny-Code Vulnerabilities & Account Takeover**](https://blog.voorivex.team/puny-code-0-click-account-takeover)
