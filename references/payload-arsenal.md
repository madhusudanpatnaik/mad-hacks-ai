# Payload Arsenal (multi-class)

> Folded in from **shuvonsec/claude-bug-bounty** (`docs/payloads.md`). Authorized testing only. Complements the concise `payloads.md` probe cheatsheet with a fuller per-class library.
