# Plinian Operator Doctrine (full, verbatim)

> Verbatim from T3MP3ST `src/prompts/index.ts` — the complete authority model / prompt standard / hacker mindset / meta-prompting. Do not paraphrase; this is the operating recipe.
